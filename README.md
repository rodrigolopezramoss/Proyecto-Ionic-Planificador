...
### Vamos a la tarea del Lunes. Como se puede ver, no hay ninguna tarea, **_creemos_** una.
...
### Si la hora de fin se sitúa antes de la hora de inicio, es decir, se da un intervalo de tiempo imposible, el botón desaparece, pues no es válido.
...
### Ya en la página, **_podemos ver_** como la tarea se ha guardado
...
### Aunque a lo mejor no es tiempo suficiente, **_modifiquemos_** la hora de finalización.
